...
- [refactor: Centralize upstream versions](https://github.com/kaito-project/airunway/pull/281) on [kaito-project/airunway](https://github.com/kaito-project/airunway) — *4 days ago*
- [chore(dynamo): bump Dynamo to `1.1.1` and install GAIE `v1.5.0`](https://github.com/kaito-project/airunway/pull/280) on [kaito-project/airunway](https://github.com/kaito-project/airunway) — *5 days ago*
