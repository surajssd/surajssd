...
- [surajssd/azure-capacity-finder](https://github.com/surajssd/azure-capacity-finder) — *6 days ago*
...
- [chore(deps): bump `dcgm-exporter` to build v6](https://github.com/Azure/AgentBaker/pull/8417) on [Azure/AgentBaker](https://github.com/Azure/AgentBaker) — *1 day ago*
- [feat(dynamo): add `setup-dynamo` and `cleanup-dynamo` Makefile targets](https://github.com/kaito-project/airunway/pull/240) on [kaito-project/airunway](https://github.com/kaito-project/airunway) — *5 days ago*
